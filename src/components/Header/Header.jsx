                ...
                <div className={style["container"]}>
                    <div className={style["header__row"]}>
                        ...
                        <div className={style["header__menu"]}>
                            ...
                            <button id='basket' className={style["header__button"]}><NavLink to='/basket'> {/* Корзина */} <i class="fas fa-shopping-cart"></i></NavLink>{this.props.count > 0 && <span>{`${this.props.count}`}</span>}</button>
                            {this.props.isAuth === true
